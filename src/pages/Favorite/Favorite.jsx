            ...
            <section className="favorite">
                <div className="favorite__container">
                    <ul className="favorite__breadcrumb">
                        <li className="favorite__breadcrumb-item"><Link className="favorite__breadcrumb-link"
                                                                        to={"/"}>Главная</Link></li>
                        {location.pathname === "/favorite" ?
                            <li className="favorite__breadcrumb-item">Избраное</li> : <>
                                <li className="favorite__breadcrumb-item">Категории</li>
                                <li className="favorite__breadcrumb-item"></li>
                            </>}
                    </ul>
                    ...
                    <div className="favorite__content">
                        ...
                        <div className="favorite__filter filter">
                            ...
                            <div className="toggle">
                                <Switch onChange={(e) => dispatch(setInStock(e.target.checked))} id='isAvailable'
                                        colorScheme='green'/>
                        ...
                        <div className="favorite__products products-favorite">
                            ...
                            <div className="products-favorite__filters">
                                <div className="products-favorite__filter active">
                                    ...
                                    <svg className="products-favorite__delete" width="24" height="24"
                                         viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRull="evenodd" clipRule="evenodd"
