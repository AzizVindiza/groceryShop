        ...
        <section className="popular">
            <div className="container">
                <div className="popular__row">
                    <h2 className="popular__title">Покупали раньше</h2>
                    <div className="popular__block">
                        <h3 className="popular__all">Все покупки</h3>
                ...
                <div className="popular__wrapper">
                    <div className="popular__box">
                        ...
                        <div className="popular__image">
                            <img className='new__pic' src={logo} alt=""/>
                        </div>
                        <div className="popular__wrapp">
                            <div className="popular__left">
                                <h4 className="popular__price">44,50</h4>
                                <span className='popular__cart'>С картой</span>
                            </div>

                        </div>
                        <p className="popular__txt">Г/Ц Блинчики с мясом вес, Россия</p>
                        <div className="popular__starts">
                            <div className="popular__svg">
                        ...
                        <button className='popular__btn'>В корзину</button>
                    </div>
                </div>
            </div>
        </section>
