        ...
        <div  className={'addCart'}>
            {
                newCategory.filter((item,idx) => item.status === 'sale').map((el) =>(
                    <div className="addCart__box">
                        ...
                        <div className="addCart__image">
                            <img className='addCart__pic' src={el.img} alt=""/>
                        </div>
                        <div className="addCart__wrapp">
                            <div className="addCart__left">
                                <h4 className="addCart__price">{el.price}</h4>
                                <span className='addCart__cart'>{}</span>
                            </div>
                        </div>
                        <p className="addCart__txt">{el.name}</p>
                        <div className="addCart__starts">
                            <div className="addCart__svg">
