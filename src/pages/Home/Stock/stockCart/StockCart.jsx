        ...
        <div className="stockCart">
            <div className="stockCart__box">
                <div className="stockCart__num">
                    <h5 className="stockCart__move">-50%</h5>
                </div>
                ...
                <div className="stockCart__image">
                    <img className='stockCart__pic' src={logo} alt=""/>
                </div>
                <div className="stockCart__wrapp">
                    <div className="stockCart__left">
                        <h4 className="stockCart__price">44,50</h4>
                ...
                <p className="stockCart__txt">Г/Ц Блинчики с мясом вес, Россия</p>
