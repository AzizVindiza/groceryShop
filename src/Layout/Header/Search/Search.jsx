...
const Search = () => {
    ...
    return (
        <label className="searchProduct">
            <input className="searchProduct__input" type="search" onChange={(e)=>{dispatch(getSearch(e.target.value))}} value={filter.name} placeholder="Найти товар"/>
            <button className="searchProduct__btn">
                <svg className="searchProduct__icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
